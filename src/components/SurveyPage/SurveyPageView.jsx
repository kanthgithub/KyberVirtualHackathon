                ...
                <>
                    ...
                    <div key={questionNumber} className={styles.containerPadding}>
                        <Container key={questionNumber}>
                            {questionNumber === 1 ? (
                                <>
                                    <h4 style={{ color: "white" }}>Answer a few multiple choice questions to see which Zap might fit your needs:</h4>
                            ...
                            <br />
                            <br />
                            <h5 style={{ color: "red", fontSize: 15 }}>DISCLOSURE: THIS IS NOT INVESTMENT ADVICE. DO NOT MAKE INVESTMENT DECISIONS SOLELY BASED ON</h5>
                            <h5 style={{ color: "red", fontSize: 15 }}>RESULTS GENERATED BY THIS TOOL. THIS PROJECT IS IN BETA. USE AT YOUR OWN DISCRETION.</h5>
                        </Container>
                    </div>
                </>
            );
