...
export default Baskets;
      ...
      //     {/* Hedger Basket */}
      //     <section className="pb-5 pt-md-12" id="hedger">
      //       <div className="container">
      ...
      //     <section className="pb-5 pt-md-12" id="shortTermBear">
      //       <div className="container">
      //         <div className="card shadow" style={{ backgroundColor: "#ffffff" }}>
      //           <div className="card-body">
      //             <div className="row justify-content-center">
      ...
      //     <section className="pb-5 pt-md-12" id="shortTermSwings">
      //       <div className="container">
      //         <div className="card shadow" style={{ backgroundColor: "#ffffff" }}>
      //           <div className="card-body">
      //             <div className="row justify-content-center">
      ...
      //     <section className="pb-5 pt-md-12" id="shortTermBull">
      //       <div className="container">
      //         <div className="card shadow" style={{ backgroundColor: "#ffffff" }}>
      //           <div className="card-body">
      //             <div className="row justify-content-center">
      ...
      //     <section className="pb-5 pt-md-12" id="longTermBull">
      //       <div className="container">
      //         <div className="card shadow" style={{ backgroundColor: "#ffffff" }}>
      //           <div className="card-body">
      //             <div className="row justify-content-center">
      ...
      //     {/* Lender Basket */}
      //     <section className="pb-5 pt-md-12" id="lender">
      //       <div className="container">
      //         <div className="card shadow" style={{ backgroundColor: "#ffffff" }}>
      //           <div className="card-body">
      //             <div className="row justify-content-center">
